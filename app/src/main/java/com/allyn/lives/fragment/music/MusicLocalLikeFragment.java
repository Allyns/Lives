...
import com.allyn.lives.presenter.MusicLikePresenter;
import com.jude.beam.bijection.RequiresPresenter;
import com.jude.beam.expansion.list.BeamListFragment;
import com.jude.beam.expansion.list.ListConfig;
import com.jude.easyrecyclerview.adapter.BaseViewHolder;

@RequiresPresenter(MusicLikePresenter.class)
public class MusicLocalLikeFragment extends BeamListFragment<MusicLikePresenter, MusicBean> {
    ...
    protected ListConfig getConfig() {
        return super.getConfig()
                ...
                .setErrorRes(R.layout.nul_layout)
                .setRefreshAble(true)
                .setErrorAble(true);
    }
}
